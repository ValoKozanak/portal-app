...
const BankTransactionsPage: React.FC = () => {
  ...
  const [transactionsData, setTransactionsData] = useState<BankTransactionsData | null>(null);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <button
                onClick={() => navigate(`/accounting/bank/${companyId}`)}
            ...
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">
                Transakcie - {transactionsData?.account?.accountNumber}
              </h1>
              <button
          ...
          <>
            ...
            <div className="bg-white dark:bg-dark-800 rounded-lg shadow p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Banka</p>
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
                    {transactionsData.account.bankName}
                  </p>
                </div>
              </div>
            </div>
