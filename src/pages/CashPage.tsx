...
const CashPage: React.FC = () => {
  ...
  const loadCashData = async () => {
    try {
      ...
      console.log('💰 Načítavam pokladňové dáta pre companyId:', companyId);

      const data = await accountingService.getCashAccounts(Number(companyId));
      console.log('💰 Pokladňové dáta načítané:', data);

      setCashData(data);
    } catch (error) {
      console.error('Chyba pri načítaní pokladňových dát:', error);
      setError('Chyba pri načítaní pokladňových dát');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">
                Pokladňa - {cashData?.company?.name}
              </h1>
              <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-purple-600 dark:text-purple-400">Počet pokladní</p>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                  {cashData?.message || 'Firma nemá žiadne pokladne (211) v účtovníctve.'}
                </div>
              </div>
            </div>
          </div>
